...
const SideNav = ({
    ...
    // Filter navigation based on current route
    // When on admin pages, only show admin menu items
    const isAdminRoute = pathname.startsWith('/admin')
    const filteredNavigationTree = isAdminRoute
        ? navigationTree.filter(item => item.key === 'adminMenu')
        : navigationTree
